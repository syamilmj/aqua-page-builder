...
if( !class_exists( 'AQ_Block' ) ) {
	class AQ_Block {
	 	...
	 	function block( $instance ) {
	 		extract( $instance );
	 		echo __( 'function AQ_Block::block should not be accessed directly. Output generated by the ', 'aq-page-builder' ) . strtoupper( $id_base ) . ' Class';
	 	}
	 	...
	 	function form( $instance ) {
	 		echo '<p class="no-options-block">' . __( 'There are no options for this block.', 'aq-page-builder' ) . '</p>';
	 		return 'noform';
	 	}
	 				...
	 				'<dl class="block-bar">',
	 					'<dt class="block-handle">',
	 						...
	 						'<span class="block-controls">',
	 							'<a class="block-edit" id="edit-' . $number . '" title="Edit Block" href="#block-settings-' . $number . '">' . __( 'Edit Block', 'aq-page-builder' ) . '</a>',
	 						'</span>',
	 					'</dt>',
	 				'</dl>',
	 	...
	 	function after_form( $instance ) {
	 		...
	 		$block_saving_id = 'aq_blocks[aq_block_' . $number . ']';
	 			...
	 			echo '<div class="block-control-actions clearfix"><a href="#" class="delete">' . __( 'Delete', 'aq-page-builder' ) . '</a> | <a href="#" class="close">' . __( 'Close', 'aq-page-builder' ) . '</a></div>';
