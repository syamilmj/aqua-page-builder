...
if(!class_exists('AQ_Block')) {
	class AQ_Block {
	 	...
	 	function block($instance) {
	 		extract($instance);
	 		echo __('function AQ_Block::block should not be accessed directly. Output generated by the ', 'aqpb') . strtoupper($id_base). ' Class';
	 	}
	 				...
	 				'<dl class="block-bar">',
	 					'<dt class="block-handle">',
	 						...
	 						'<span class="block-controls">',
	 							'<a class="block-edit" id="edit-'.$number.'" title="'. __('Edit Block', 'aqpb') .'" href="#block-settings-'.$number.'">'. __('Edit Block', 'aqpb') .'</a>',
	 						'</span>',
	 					'</dt>',
	 				'</dl>',
	 	...
	 	function after_form($instance) {
	 		...
	 		$block_saving_id = 'aq_blocks[aq_block_'.$number.']';
	 			...
	 			echo '<div class="block-control-actions clearfix"><a href="#" class="delete">'. __('Delete', 'aqpb') .'</a> | <a href="#" class="close">'. __('Close', 'aqpb') .'</a></div>';
