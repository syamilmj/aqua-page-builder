...
var wpNavMenu;
(function(b) {
    var a = wpNavMenu = {options: {menuItemDepthPerLevel: 30,globalMaxDepth: 11},menuList: undefined,targetList: undefined,menusChanged: false,isRTL: !!("undefined" != typeof isRtl && isRtl),negateIfRTL: ("undefined" != typeof isRtl && isRtl) ? -1 : 1,init: function() {
            ...
            b.fn.extend({menuItemDepth: function() {
                    ...
                    return this.each(function() {
                        var d = b(this), e = d.menuItemDepth();
                        b(this).removeClass("menu-item-depth-" + e).addClass("menu-item-depth-" + (e + c))
                    })
                },childMenuItems: function() {
                    var c = b();
                    this.each(function() {
                        var d = b(this), f = d.menuItemDepth(), e = d.next();
                    ...
                    return this.each(function() {
                        var e = b(this), c = e.find(".menu-item-data-parent-id"), f = e.menuItemDepth(), d = e.prev();
                        if (f == 0) {
                            c.val(0)
                        } else {
                    ...
                    return this.each(function() {
                        var e = b(this), d = {}, g = e.find(".tabs-panel-active .categorychecklist li input:checked"), f = new RegExp("menu-item\\[([^\\]]*)");
                        ...
                        b(g).each(function() {
                            var i = b(this), h = f.exec(i.attr("name")), j = "undefined" == typeof h[1] ? 0 : parseInt(h[1], 10);
                    ...
                    f = f || "menu-item";
                    var d = {}, e, c = ["menu-item-db-id", "menu-item-object-id", "menu-item-object", "menu-item-parent-id", "menu-item-position", "menu-item-type", "menu-item-title", "menu-item-url", "menu-item-description", "menu-item-attr-title", "menu-item-target", "menu-item-classes", "menu-item-xfn"];
                    if (!g && f == "menu-item") {
            ...
            var p = 0, e, t, d, l, o, f, c, i, s, m = a.menuList.offset().left, h = b("body"), q, n = r();
            m += a.isRTL ? a.menuList.width() : 0;
            a.menuList.sortable({handle: ".menu-item-handle",placeholder: "sortable-placeholder",start: function(A, z) {
                    var u, x, w, v, y;
                    if (a.isRTL) {
                    ...
                    var y = v.helper.offset(), u = a.isRTL ? y.left + v.helper.width() : y.left, x = a.negateIfRTL * a.pxToDepth(u - m);
                    if (x > d || y.top < f) {
                        x = d
                    } else {
                        if (x < t) {
            ...
            b('#add-custom-links input[type="text"]').keypress(function(d) {
                if (d.keyCode === 13) {
                    d.preventDefault();
                    b("#submit-customlinkdiv").click()
                }
            })
        },setupInputWithDefaultTitle: function() {
            var c = "input-with-default-title";
            b("." + c).each(function() {
                var f = b(this), e = f.attr("title"), d = f.val();
                f.data(c, e);
                if ("" == d) {
                    f.val(e)
                } else {
            ...
            var d = b("#nav-menu-theme-locations"), c = {};
            ...
            g = {action: "menu-quick-search","response-format": "markup",menu: b("#menu").val(),"menu-settings-column-nonce": b("#menu-settings-column-nonce").val(),q: f,type: d.attr("name")};
            b("img.waiting", c).show();
            b.post(ajaxurl, g, function(h) {
                a.processQuickSearchQueryResponse(h, g, c)
            })
        },addCustomLink: function(c) {
            var e = b("#custom-menu-item-url").val(), d = b("#custom-menu-item-name").val();
            c = c || a.addMenuItemToBottom;
            if ("" == e || "http://" == e) {
                return false
            }
            ...
            a.addItemToMenu({"-1": {"menu-item-type": "custom","menu-item-url": e,"menu-item-title": d}}, c, f)
        },addItemToMenu: function(e, c, g) {
            var f = b("#menu").val(), d = b("#menu-settings-column-nonce").val();
            c = c || function() {
            };
            g = g || function() {
            };
            params = {action: "add-menu-item",menu: f,"menu-settings-column-nonce": d,"menu-item": e};
            ...
            if (0 != b("#menu-to-edit").length) {
                ...
                b("#menu-settings-column").find("input,select").prop("disabled", true).end().find("a").attr("href", "#").unbind("click")
            }
                        ...
                        if (g.hasClass("submit-add-to-menu")) {
                            ...
                            if (g.hasClass("page-numbers")) {
                                b.post(ajaxurl, h.target.href.replace(/.*\?/, "").replace(/action=([^&]*)/, "") + "&action=menu-get-metabox", function(m) {
                                    ...
                                    var l = b.parseJSON(m), e = document.getElementById(l["replace-id"]), k = document.createElement("div"), j = document.createElement("div");
                                    if (!l.markup || !e) {
                                        return
                                    }
            ...
            var h = b(".nav-tabs-wrapper"), j = h.children(".nav-tabs"), g = j.children(".nav-tab-active"), m = j.children(".nav-tab"), e = 0, o, f, l, d, k, i = {}, c = a.isRTL ? "margin-right" : "margin-left", p = a.isRTL ? "margin-left" : "margin-right", n = 2;
            ...
            b.fn.extend({makeTabVisible: function() {
                    var u = this.eq(0), v, s, r = {}, q = 0;
                    if (!u.length) {
                        return this
                    }
                    v = u.offset().left;
                    ...
                    var r = this.eq(0), s = r.offset().left, q = s + r.outerWidth();
            ...
            b.each([{arrow: l,next: "next",last: "first",operator: "+="}, {arrow: d,next: "prev",last: "last",operator: "-="}], function() {
                var q = this;
                this.arrow.mousedown(function() {
                    var t = Math.abs(parseInt(j.css(c))), r = t, s = {};
                    if ("-=" == q.operator) {
            ...
            var e, i, f = {}, d = document.getElementById("nav-menu-meta"), j = new RegExp("menu-item\\[([^\\]]*)", "g"), h = b("<div>").html(g).find("li"), l;
            if (!h.length) {
            ...
            d.addClass("deleting").animate({opacity: 0,height: 0}, 350, function() {
