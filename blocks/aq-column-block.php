...
class AQ_Column_Block extends AQ_Block {
	...
	function __construct() {
		...
		$block_options = array(
			'name' => __( 'Column', 'aq-page-builder' ),
			'size' => 'span6',
		);
				...
				'<dl class="block-bar">',
					'<dt class="block-handle">',
						...
						'<span class="block-controls">',
							'<a class="block-edit" id="edit-' . $number . '" title="' . __( 'Edit Block', 'aq-page-builder' ) . '" href="#block-settings-' . $number . '">' . __( 'Edit Block', 'aq-page-builder' ) . '</a>',
						'</span>',
					'</dt>',
				'</dl>',
	...
	function form( $instance ) {
		...
		__( 'Drag block items into this column box', 'aq-page-builder' ),
		'</p>';
	...
	function after_form( $instance ) {
		...
		$block_saving_id = 'aq_blocks[aq_block_' . $number . ']';
			...
			echo '<div class="block-control-actions cf"><a href="#" class="delete">' . __( 'Delete', 'aq-page-builder' ) . '</a></div>';
