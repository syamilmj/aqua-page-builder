...
if( !class_exists( 'AQ_Tabs_Block' ) ) {
	class AQ_Tabs_Block extends AQ_Block {
		...
		function __construct() {
			$block_options = array(
				'name' => __( 'Tabs &amp; Toggles', 'aq-page-builder' ),
				'size' => 'span6',
			);
		...
		function form( $instance ) {
			...
			$defaults = array(
				'tabs' => array(
					1 => array(
						'title' => __( 'My New Tab', 'aq-page-builder' ),
						'content' => __( 'My tab contents', 'aq-page-builder' ),
					)
				),
				'type'	=> 'tab',
			);
			...
			$tab_types = array(
				'tab' => __( 'Tabs', 'aq-page-builder' ),
				'toggle' => __( 'Toggles', 'aq-page-builder' ),
				'accordion' => __( 'Accordion', 'aq-page-builder' )
			);
			...
			<div class="description cf">
				...
				<p></p>
				<a href="#" rel="tab" class="aq-sortable-add-new button"><?php _e( 'Add New', 'aq-page-builder' ); ?></a>
				<p></p>
			</div>
			<p class="description">
				<label for="<?php echo $this->get_field_id( 'type' ); ?>">
					<?php _e( 'Tabs style', 'aq-page-builder' ); ?><br/>
			...
			<li id="<?php echo $this->get_field_id( 'tabs' ); ?>-sortable-item-<?php echo $count; ?>" class="sortable-item" rel="<?php echo $count; ?>">
				...
				<div class="sortable-head cf">
					...
					<div class="sortable-handle">
						<a href="#"><?php _e( 'Open / Close', 'aq-page-builder' ); ?></a>
					</div>
				</div>
				...
				<div class="sortable-body">
					<p class="tab-desc description">
						<label for="<?php echo $this->get_field_id( 'tabs' ) ?>-<?php echo $count; ?>-title">
							<?php _e( 'Tab Title', 'aq-page-builder' ); ?><br/>
					...
					<p class="tab-desc description">
						<label for="<?php echo $this->get_field_id( 'tabs' ); ?>-<?php echo $count; ?>-content">
							<?php _e( 'Tab Content', 'aq-page-builder' ); ?><br/>
					...
					<p class="tab-desc description"><a href="#" class="sortable-delete"><?php _e( 'Delete', 'aq-page-builder' ); ?></a></p>
				</div>
		...
		function add_tab() {
			...
			$tab = array(
				'title' => __( 'New Tab', 'aq-page-builder' ),
				'content' => ''
			);
